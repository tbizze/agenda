...
function submit() {
  router.get(route("evento-locals.index"), form);
}
/**
 * Função para abrir formulário de cadastro.
 */
function actionAdd() {
  router.get(route("evento-locals.create"));
}
/**
...
function actionEdit(id) {
  router.get(route("evento-locals.edit", id));
}
/**
...
function actionDelete(id) {
  router.delete(route("evento-locals.destroy", id)); // Requisita ao controller a exclusão.
