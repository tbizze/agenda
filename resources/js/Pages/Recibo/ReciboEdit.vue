...
const form = useForm({
  ...
  data_pgto: props.registro.data,
  local: props.registro.local,
  historico: props.registro.historico,
  pagador: props.registro.pagador,
  cpf_cnpj_pagad: props.registro.cpf_cnpj_pagad,
  recebedor: props.registro.recebedor,
  cpf_cnpj_receb: props.registro.cpf_cnpj_receb,
 ...
 */
/* function submit() {
  form.put(route("recibos.update", props.registro.id));
} */
